...
function Command(_a) {
    ...
    return (_jsx(CommandPrimitive, Object.assign({ "data-slot": "command", className: cn("bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-md", className) }, props)));
}
function CommandDialog(_a) {
    var { title = "Command Palette", description = "Search for a command to run...", children, className } = _a, props = __rest(_a, ["title", "description", "children", "className"]);
